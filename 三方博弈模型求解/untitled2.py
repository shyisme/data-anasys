# -*- coding: utf-8 -*-
"""
Created on Mon May  7 17:14:46 2018
...
f1=x*(1-x)*(y*z*(-a-e-f)+y*(1-z)*(-a-e+d)+
           (1-y)*z*(-a+c-f+b)+(1-y)*(1-z)*(-a+c+d+b))
f2=y*(1-y)*(x*z*(e+c+j-h)+x*(1-z)*(e+c+i-h)+
           (1-x)*z*(j-h)+(1-x)*(1-z)*(i-h))
f3=z*(1-z)*(x*y*(f+l+d)+x*(1-y)*(f-m+l+d)+
            (1-x)*y*l+(1-x)*(1-y)*(-m+l))
